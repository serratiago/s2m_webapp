...
$SQL .= "FROM [dbo].[tbl_monitor] order by [int_id_log_monitor] desc) tbl order by int_id_log_monitor asc";
...
?>
<div class="titulo_grafico">Atividade Cardíaca
<div id="div_chart_cardio" class="div_grafico"></div>
</div>
</html>
