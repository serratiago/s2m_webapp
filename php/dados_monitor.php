...
$SQL .= "[int_num_temp_Corporal_log_monitor],[int_num_umidade_Ambiente_log_monitor],[int_num_temp_Ambiente_log_monitor] ";
$SQL .= "FROM [dbo].[tbl_monitor] order by [int_id_log_monitor] desc";
	...
	$count = 0;
     ...
     foreach ($result as $row){
     		...
     		$int_num_temperatura_Ambiente_log_monitor = str_replace(',', '.', $row["int_num_temp_Ambiente_log_monitor"]);
	}
?>
